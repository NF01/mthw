...
<template>
    ...
    <modal-admin v-show="isModalVisible == 'adminAddQuestion'" @close="closeModal">
        ...
        <template v-slot:body>
            ...
            <input type="button" class="btn btn-secondary full-width input-mobile" value="Vrai/Faux avec image"
                @click="setQuestionType('VFImage',1)" />
            <input type="button" class="btn btn-secondary full-width input-mobile" value="Vrai/Faux sans image"
                @click="setQuestionType('VF',2)" />
            <input type="button" class="btn btn-secondary full-width input-mobile"
                value="Vrai/Faux avec réponse en image" @click="setQuestionType('VFReponseImage',typeQuestionId = 3)" />
            <input type="button" class="btn btn-secondary full-width input-mobile" value="QCM avec image"
                @click="setQuestionType('QCMImage',4)" />
            <input type="button" class="btn btn-secondary full-width input-mobile" value="QCM sans image"
    ...
    <modal-admin v-show="isModalVisible == 'adminChapitre'" @close="closeModal">
        ...
        <template v-slot:body>
            ...
            <div class="row">
                <div class="col">
                    <div type="button" class="btn btn-secondary  canton-btn full-width mb-3"
                        @click="questionChapitre = 1">Genève</div>
                </div>
                <div class="col">
                    <div type="button" class="btn btn-secondary  canton-btn full-width mb-3"
                        @click="questionChapitre = 2">Vaud</div>
                </div>
                <div class="col">
                    <div type="button" class="btn btn-secondary  canton-btn full-width" @click="questionChapitre = 3">
                        Lucerne</div>
                    <div class="w-100"></div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div type="button" class="btn btn-secondary  canton-btn full-width mb-3"
                        @click="questionChapitre = 4">Fribourg</div>
                </div>
                <div class="col">
                    <div type="button" class="btn btn-secondary canton-btn full-width" @click="questionChapitre = 5">
                        Schaffouse</div>
                    <div class="w-100"></div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div type="button" class="btn btn-secondary canton-btn full-width mb-3"
                        @click="questionChapitre = 6">Valais</div>
                </div>
                <div class="col">
                    <div type="button" class="btn btn-secondary canton-btn full-width" @click="questionChapitre = 7">
                        Bâle</div>
                    <div class="w-100"></div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div type="button" class="btn btn-secondary canton-btn full-width mb-3"
                        @click="questionChapitre = 8">Tessin</div>
                </div>
                <div class="col">
                    <div type="button" class="btn btn-secondary canton-btn full-width" @click="questionChapitre = 9">
                        Berne</div>
                    <div class="w-100"></div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div type="button" class="btn btn-secondary canton-btn full-width mb-3"
                        @click="questionChapitre = 10">Grisons</div>
                </div>
                <div class="col">
                    <div type="button" class="btn btn-secondary canton-btn full-width" @click="questionChapitre = 11">
                        Neuchâtel</div>
                    <div class="w-100"></div>
                </div>
            </div>
            <div class="d-flex justify-content-center">
                <input class="btn btn-secondary canton-btn col-5 input-mobile" value="Lavaux" />
            </div>
        ...
        <template v-slot:body>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <h3>Question</h3>
                        <textarea class="input-modal full-width" row="3"
                            placeholder="Quelle est la question ?"></textarea><br />
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="customFileLang" lang="fr" />
                            <label class="custom-file-label" for="customFileLang">Charger une image
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <input type="button" class="btn btn-secondary full-width mb-3" value="Vrai" />
                    </div>
                    <div class="col">
                        <input type="button" class="btn btn-secondary full-width" value="Faux" />
                    </div>
                    <div class="w-100"></div>
                </div>
                <div class="row pt-4 pb-5">
                    <div class="col">
                        <h3>Anecdote liée</h3>
                        <textarea class="input-modal full-width" row="3"
                            placeholder="Ajouter une anecdote s'il y en a une."></textarea>
                    </div>
                </div>
            </div>
        ...
        <template v-slot:body>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <h3>Question</h3>
                        <textarea v-model="questionAdded" class="input-modal full-width" row="3"
                            placeholder="Quelle est la question ?"></textarea>
                    </div>
                </div>
                <div class="row pt-4">
                    <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="custom-file">
                            ...
                            <input type="file" class="custom-file-input" id="customFileLang" lang="fr" />
                            <label class="custom-file-label" for="customFileLang">Vrai image
                            </label>
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="customFileLang" lang="fr" />
                            <label class="custom-file-label" for="customFileLang">Fausse image
                            </label>
                        </div>
                    </div>
                    <div class="w-100"></div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <textarea class="input-modal full-width" placeholder="Réponse juste"></textarea>
                            </div>
                            <div class="col">
                                <textarea class="input-modal full-width" placeholder="Réponse fausse"></textarea>
                                <div class="w-100"></div>
                            </div>
                        </div>
                        <div class="row">
