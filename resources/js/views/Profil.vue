            ...
            <div class="col-lg-8 mx-auto">
                <div class="row justify-content-center pt-3">
                    ...
                    <div class="col text-right">
                        <a class="btn btn-primary smaller mx-auto edit-icon" href="#edit" uk-toggle><svg
                                xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="white"
                ...
                <div class="row text-center justify-content-center">
                    <a :href="URL_PREFIX + 'logout'" class="btn btn-primary small mx-auto">Se déconnecter</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="uk-modal-dialog uk-margin-auto-vertical modal-login px-3 py-2">
            <form method="PUT" v-on:submit.prevent="updateUser()" class="col px-2">
                ...
                <div class="row align-items-center">
                    <div class="col py-default">
                        <div class="form-group">
                            ...
                            <input v-model="updatedName" type="pseudo" id="pseudo" class="form-control" name="pseudo"
                                :placeholder='user.name' autofocus />
                        </div>
                        <div class="form-group">
                            <label for="email">Adresse Email</label>
                            <input v-model="updatedEmail" type="email" id="email" class="form-control" name="email"
                                :placeholder='user.email' />
                        </div>
                        <div class="form-group">
                            <label for="password">Mot de passe</label>
                            <input v-model="updatedPassword" type="password" id="password" class="form-control"
                                name="password" autocomplete="current-password" :placeholder='user.password' />
                        </div>
                    </div>
                </div>
                <div class="row border-top pt-4 mt-auto">
                    <div class="col">
                        <div class="row my-3">
                            <button @click="updateUser();" type="submit" class="btn btn-primary full-width uk-modal-close">
                                Modifier
                            </button>
                        </div>
                    </div>
