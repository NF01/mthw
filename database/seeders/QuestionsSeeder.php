...
class QuestionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $enonce = [
            ...
            "Quel est le starter pack du vrai schaffhousien ?", "La ville de Schaffhouse a été bombardée lors de la 2ème guerre mondiale.", "Les chutes du Rhin sont les plus grandes chutes...", "Trouve l'écusson du canton de Schaffhouse.", "En 2018, Schaffhouse est le premier canton à mettre en place…", "Trouve les chutes du Rhin.", "Un gardien sonne à la main la cloche du Munot tous les soirs à Schaffouhouse.", "Trouve la vieille ville de Schaffhouse.", "Bonus",
