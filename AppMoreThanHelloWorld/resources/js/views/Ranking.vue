    ...
    export default {
        ...
        setup() {
            ...
            const fetchData = async () => {
                ...
                const fetchAllUser = await fetch("/api/users/xp");
...
<template>
    <div class="page">
        ...
        <section class="container caption">
            <img class="img-fluid" id="podium" src="/img/classement_couleur.png" alt="podium" />
        ...
        <section class="container">
            <div class="row" v-if="allUser[3]">
                ...
                <div class="col-2">
                    <img class="image" src="/img/edelweiss.png" alt="points" />
                </div>
            </div>
            ...
            <template v-if="allUser[5]">
                <template v-if="user.experience < allUser[5].experience">
                    <div class="espace">
                        <img id="espace" src="/img/petits_points.png" alt="espace" />
                    </div>
                    <span class="row">
